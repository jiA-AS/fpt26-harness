...
In this circuit, create a 512-cell system (q[512]), and advance by one time step each clock cycle. The load input indicates the state of the system should be loaded with data[512]. Assume the boundaries (q[-1] and q[512]) are both zero (off).
